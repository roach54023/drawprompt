...
export const blogArticles: BlogArticle[] = [
  ...
  // ── 13. Cool Prompts: 6 GPT Image 2 Prompts That Blew My Mind ──
  {
    ...
    body: [
      ...
      { type: "image-placeholder", alt: "Elon Musk TikTok Livestream \u2014 generated by GPT Image 2", caption: "A photorealistic TikTok livestream screenshot. ~200 words." },
      { type: "paragraph", text: "This prompt describes every UI element of a TikTok livestream \u2014 floating hearts, scrolling comments, gift animations, the \u201Clive\u201D badge. The result is uncanny. GPT Image 2 isn\u2019t just generating images \u2014 it\u2019s generating interfaces." },
      { type: "callout", text: "See the full 200-word prompt.", href: "/prompts/elon-musk-tiktok-livestream-screenshot", linkText: "View prompt \u2192" },
...

  {
    ...
    title: "4 Fresh AI Image Prompts You Should Try This Week (May 2025)",
    description: "From pathetic art creatures to 2008 family photos \u2014 4 wildly different GPT Image 2 prompts we found this week that push AI art in unexpected directions.",
    date: "2025-05-11",
    category: "cool-prompts",
    ...
    heroBg: "#eef2ff",
    body: [
      { type: "paragraph", text: "Every week we hunt for the most interesting AI image prompts floating around the internet \u2014 GitHub repos, Twitter threads, Reddit posts, Chinese creator communities. This week\u2019s batch is one of our favorites: four prompts that each push GPT Image 2 in a completely different direction, from crude emotional art to pixel-perfect technical illustration." },

      { type: "heading", text: "1. Pathetic Art \u2014 The Anti-Aesthetic" },
      ...
      { type: "prompt-example", prompt: "Redraw the attached image in the most clumsy, scribbly, and utterly pathetic way possible. Use a white background, and make it look like it was drawn in MS Paint with a mouse. It should be vaguely similar but also not really, kind of matching but also off in a confusing, awkward way, with that low-quality pixel-by-pixel feel that really emphasizes how ridiculously bad it is. Actually, you know what, whatever, just draw it however you want.", note: "Original prompt from neuronad.com — attach any image and let GPT redraw it badly." },
      ...
      { type: "heading", text: "2. VR Headset Exploded View" },
      ...
      { type: "prompt-example", prompt: "{\n  \"type\": \"Product Exploded View Poster\",\n  \"subject\": \"VR Headset\",\n  \"style\": \"Clean high-tech 3D render, studio lighting, glowing accents\",\n  \"background\": \"Soft purple-blue gradient\",\n  \"header\": { \"logo\": \"∞ Meta Quest 3\", \"subtitle\": \"Reimagine reality with an entirely new structure.\" },\n  \"layout\": { \"centerpiece\": \"Vertical stacked exploded view of a VR headset showing 9 different internal component layers\" }\n}", note: "This is a structured JSON prompt by @WORY via appark.ai (translated from Chinese) — see the full version with all 8 callout labels on the prompt detail page." },
      ...
      { type: "heading", text: "3. Learn English \u2014 Photo Vocabulary Annotation" },
      ...
      { type: "paragraph", text: "Not every prompt needs to be artistic. This one is purely practical: upload any everyday photo and the AI annotates it with English vocabulary. The original prompt (written in Chinese) instructs GPT Image 2 to identify 5 objects, draw white hand-drawn-style outlines around them, and label each with an English word, simple definition, and example sentence. The result looks like someone sketched learning notes directly onto the photo \u2014 clean, natural, with breathing room. If you\u2019re a teacher, course creator, or edu-content maker, this saves you hours compared to Canva or stock photos." },
      { type: "prompt-example", prompt: "[Task Goal] Identify 5 objects in the photo and add for each: 1. English word 2. Simple English definition 3. Optional short example sentence\n\n[Annotation Count] Only label 5 objects, no more than 5. Prioritize common, easy-to-learn everyday items.\n\n[Drawing Style] Use white thin-line hand-drawn style annotations. Lines should look casually sketched, with a one-stroke feel. Lightly trace around the object edges.\n\n[Text Style] Primarily in English. Keep explanations simple, suitable for beginners. Don't write like a dictionary — more like visual vocabulary learning notes.\n\n[Overall Feel] Like hand-written English learning annotations on an everyday photo. Clean, natural, with breathing room. Make the aspect ratio 9:16", note: "Translated from Chinese. Original prompt by @林悦己Cheer via appark.ai — upload any photo and it becomes a vocabulary card." },
      { type: "callout", text: "See how to adapt this for any subject.", href: "/prompts/photo-to-vocabulary-card", linkText: "View prompt \u2192" },

      { type: "heading", text: "4. 2008 Family Photo \u2014 Controlled Imperfection" },
