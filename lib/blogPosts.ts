...
export const blogArticles: BlogArticle[] = [
...

  {
    ...
    body: [
      ...
      { type: "prompt-example", prompt: "【任务目标】 在照片中识别 5 个物品，并为每个物品添加：1. 英文单词 2. 简单英文释义 3. 可选的简短例句\n\n【标注数量】只标记 5 个物品，不要超过 5 个。优先选择日常生活中常见、容易学习的物品。\n\n【画法要求】用白色细线手绘风格标注。线条像随手画上去的，一笔画感。沿着物体边缘轻轻描一圈轮廓。\n\n【文字风格】以英文为主。解释要简单，适合初学者。不要写得像词典，更像看图学单词的小笔记。\n\n【整体感觉】像日常照片上的英语学习手写注释。清爽、自然、有留白。Make the aspect ratio 9:16", note: "Original Chinese prompt by @林悦己Cheer via appark.ai — upload any photo and it becomes a vocabulary card." },
