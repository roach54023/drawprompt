...
export const blogArticles: BlogArticle[] = [
...

  {
    ...
    body: [
      ...
      { type: "paragraph", text: "Looking at all five together, there\u2019s a pattern: the best prompts are specific about intent, not just content. \u2018Pathetic art\u2019 works because it names the style explicitly. The 2008 photo works because it lists exact clothing and environmental details. The VR headset works because the JSON structure gives the AI a precise visual blueprint. And the Chinese-language prompts (VR, Learn English) prove that GPT Image 2 handles non-English instructions beautifully. Vague prompts get vague results. The more precisely you describe the feeling, era, or visual language you want, the better the AI delivers." },
